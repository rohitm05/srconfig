...
@$u=$_SESSION["username"];
 ?>
 <a href="userhome.php" align="left"><img src="back.jpg" style="height: 20px; width: 20px; float: left;"></a>
...
@$co=mysql_query("select count(*) from users where year='".$s."'");
if($arr=mysql_fetch_array($co)) 
{?>
<br><br><br>
<center>
<legend>Year Statistic</legend>
<table border="4" style="background-color: cyan; border-color: red;">
	<tr>
		<th colspan="2">year</th><th colspan="2">count</th>
	</tr>
	<tr>
